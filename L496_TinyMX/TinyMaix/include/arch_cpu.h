...
TM_INLINE  void tm_dot_prod_pack4(mtype_t* sptr, mtype_t* kptr, uint32_t size, sumtype_t* result)
{ 
    sumtype_t sum0 = 0;
    sumtype_t sum1 = 0;
	sumtype_t sum2 = 0;
    ...
    uint32_t cnt = (size>>3)<<3;  //8
    for(; i+8-1 <cnt; ){
        sum0 += sptr[i]*kptr0[i]; sum1 += sptr[i]*kptr1[i]; sum2 += sptr[i]*kptr2[i];sum3 += sptr[i]*kptr3[i];i++;
        sum0 += sptr[i]*kptr0[i]; sum1 += sptr[i]*kptr1[i]; sum2 += sptr[i]*kptr2[i];sum3 += sptr[i]*kptr3[i];i++;
			sum0 += sptr[i]*kptr0[i]; sum1 += sptr[i]*kptr1[i]; sum2 += sptr[i]*kptr2[i];sum3 += sptr[i]*kptr3[i];i++;
			sum0 += sptr[i]*kptr0[i]; sum1 += sptr[i]*kptr1[i]; sum2 += sptr[i]*kptr2[i];sum3 += sptr[i]*kptr3[i];i++;
			sum0 += sptr[i]*kptr0[i]; sum1 += sptr[i]*kptr1[i]; sum2 += sptr[i]*kptr2[i];sum3 += sptr[i]*kptr3[i];i++;
